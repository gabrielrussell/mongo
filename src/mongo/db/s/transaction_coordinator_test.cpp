...
TEST_F(TransactionCoordinatorMetricsTest, SimpleTwoPhaseCommitRealCoordinator) {
    ...
    LOGV2(22170, "Create the coordinator.");
    ...
    LOGV2(22172, "Allow the coordinator to progress to waiting for votes.");
    ...
    LOGV2(22173, "Allow the coordinator to progress to writing the decision.");
    ...
    LOGV2(22174, "Allow the coordinator to progress to waiting for acks.");
    ...
    LOGV2(22175, "Allow the coordinator to progress to deleting the coordinator doc.");
    ...
    LOGV2(22176, "Allow the coordinator to complete.");
