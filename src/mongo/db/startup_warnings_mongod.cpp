...
void logMongodStartupWarnings(const StorageGlobalParams& storageParams,
    ...
    if (sizeof(int*) == 4) {
        LOGV2_OPTIONS(21063, {logv2::LogTag::kStartupWarnings}, "");
        LOGV2_OPTIONS(
            21064, {logv2::LogTag::kStartupWarnings}, "** NOTE: This is a 32 bit MongoDB binary.");
        LOGV2_OPTIONS(21065,
    ...
    if (!ProcessInfo::blockCheckSupported()) {
        LOGV2_OPTIONS(21068, {logv2::LogTag::kStartupWarnings}, "");
        LOGV2_OPTIONS(
            21069,
            {logv2::LogTag::kStartupWarnings},
    ...
    if (boost::filesystem::exists("/proc/vz") && !boost::filesystem::exists("/proc/bc")) {
        LOGV2_OPTIONS(21072, {logv2::LogTag::kStartupWarnings}, "");
        LOGV2_OPTIONS(21073,
                      {logv2::LogTag::kStartupWarnings},
    ...
    try {
        ...
        LOGV2_OPTIONS(21074, {logv2::LogTag::kStartupWarnings}, "");
        LOGV2_OPTIONS(21075,
                      {logv2::LogTag::kStartupWarnings},
        ...
        if (f.is_open()) {
            ...
            if (f.fail()) {
                ...
                if ((where == std::string::npos) || (++where == line.size())) {
                    LOGV2_OPTIONS(21076, {logv2::LogTag::kStartupWarnings}, "");
                    LOGV2_OPTIONS(21077,
                                  {logv2::LogTag::kStartupWarnings},
                ...
                // issue the warning.
                    ...
                    LOGV2_OPTIONS(21078, {logv2::LogTag::kStartupWarnings}, "");
                    LOGV2_OPTIONS(21079,
                                  {logv2::LogTag::kStartupWarnings},
    ...
    if (storageParams.dur) {
        ...
        if (val == 2) {
            LOGV2_OPTIONS(21082, {logv2::LogTag::kStartupWarnings}, "");
            LOGV2_OPTIONS(21083,
                          {logv2::LogTag::kStartupWarnings},
    ...
    if (boost::filesystem::exists("/proc/sys/vm/zone_reclaim_mode")) {
        ...
        if (val != 0) {
            LOGV2_OPTIONS(21085, {logv2::LogTag::kStartupWarnings}, "");
            LOGV2_OPTIONS(21086,
                          {logv2::LogTag::kStartupWarnings},
                          "** WARNING: /proc/sys/vm/zone_reclaim_mode is {val}",
                          "val"_attr = val);
            LOGV2_OPTIONS(
                21087, {logv2::LogTag::kStartupWarnings}, "**          We suggest setting it to 0");
            LOGV2_OPTIONS(21088,
                          {logv2::LogTag::kStartupWarnings},
    ...
    if (transparentHugePagesEnabledResult.isOK()) {
        if (transparentHugePagesEnabledResult.getValue() == "always") {
            ...
            LOGV2_OPTIONS(21089, {logv2::LogTag::kStartupWarnings}, "");
            LOGV2_OPTIONS(21090,
                          {logv2::LogTag::kStartupWarnings},
            ...
            warned = true;
               ...
               ErrorCodes::NonExistentPath) {
        LOGV2_WARNING_OPTIONS(21113, {logv2::LogTag::kStartupWarnings}, "");
        LOGV2_WARNING_OPTIONS(21114,
                              {logv2::LogTag::kStartupWarnings},
    ...
    if (transparentHugePagesDefragResult.isOK()) {
        if (shouldWarnAboutDefragAlways &&
            ...
            LOGV2_OPTIONS(21092, {logv2::LogTag::kStartupWarnings}, "");
            LOGV2_OPTIONS(21093,
                          {logv2::LogTag::kStartupWarnings},
        ...
        LOGV2_WARNING_OPTIONS(21115, {logv2::LogTag::kStartupWarnings}, "");
        LOGV2_WARNING_OPTIONS(21116,
                              {logv2::LogTag::kStartupWarnings},
    ...
    if (!getrlimit(RLIMIT_NOFILE, &rlnofile)) {
        if (rlnofile.rlim_cur < minNumFiles) {
            LOGV2_OPTIONS(21095, {logv2::LogTag::kStartupWarnings}, "");
            LOGV2_OPTIONS(21096,
                          {logv2::LogTag::kStartupWarnings},
        ...
        LOGV2_OPTIONS(21097, {logv2::LogTag::kStartupWarnings}, "");
        LOGV2_OPTIONS(21098,
                      {logv2::LogTag::kStartupWarnings},
...
// Solaris does not have RLIMIT_MEMLOCK, these are exposed via getrctl(2) instead
    ...
    if (!getrlimit(RLIMIT_MEMLOCK, &rlmemlock)) {
        if ((rlmemlock.rlim_cur / ProcessInfo::getPageSize()) < minLockedPages) {
            LOGV2_OPTIONS(21099, {logv2::LogTag::kStartupWarnings}, "");
            LOGV2_OPTIONS(
                21100,
                {logv2::LogTag::kStartupWarnings},
        ...
        const auto errmsg = errnoWithDescription();
        LOGV2_OPTIONS(21101, {logv2::LogTag::kStartupWarnings}, "");
        LOGV2_OPTIONS(21102,
                      {logv2::LogTag::kStartupWarnings},
                      "** WARNING: getrlimit failed. {errmsg}",
                      "errmsg"_attr = errmsg);
    ...
    if (p.hasNumaEnabled()) {
        LOGV2_OPTIONS(21103, {logv2::LogTag::kStartupWarnings}, "");
        LOGV2_OPTIONS(21104,
                      {logv2::LogTag::kStartupWarnings},
                      "** WARNING: You are running on a NUMA machine.");
        LOGV2_OPTIONS(21105,
    ...
    if (storageParams.engine == "ephemeralForTest") {
        LOGV2_OPTIONS(21108, {logv2::LogTag::kStartupWarnings}, "");
        LOGV2_OPTIONS(21109,
                      {logv2::LogTag::kStartupWarnings},
                      "** NOTE: The ephemeralForTest storage engine is for testing only. ");
        LOGV2_OPTIONS(
            21110, {logv2::LogTag::kStartupWarnings}, "**       Do not use in production.");
        warned = true;
    }

    if (warned) {
        LOGV2_OPTIONS(21111, {logv2::LogTag::kStartupWarnings}, "");
    }
}
}  // namespace mongo
