...
void logCommonStartupWarnings(const ServerGlobalParams& serverParams) {
    ...
    bool warned = false;
    {
        ...
        if ((vii.minorVersion() % 2) != 0) {
            LOGV2_OPTIONS(21028, {logv2::LogTag::kStartupWarnings}, "");
            LOGV2_OPTIONS(21029,
    ...
    if (serverParams.authState == ServerGlobalParams::AuthState::kUndefined) {
        LOGV2_OPTIONS(21031, {logv2::LogTag::kStartupWarnings}, "");
        LOGV2_OPTIONS(21032,
                      {logv2::LogTag::kStartupWarnings},
    ...
    if (is32bit) {
        LOGV2_OPTIONS(21034, {logv2::LogTag::kStartupWarnings}, "");
        LOGV2_OPTIONS(21035,
                      {logv2::LogTag::kStartupWarnings},
    ...
    if (sslGlobalParams.sslAllowInvalidCertificates) {
        ...
        LOGV2_OPTIONS(21039, {logv2::LogTag::kStartupWarnings}, "");
    }
    ...
    if (sslGlobalParams.sslAllowInvalidHostnames) {
        ...
        LOGV2_OPTIONS(21042, {logv2::LogTag::kStartupWarnings}, "** untrusted parties");
    }
#endif
...
#ifdef MONGO_CONFIG_SSL_CERTIFICATE_SELECTORS
        LOGV2(21045, "**          and no sslCertificateSelector has been specified.");
#endif
        LOGV2(21046, "**          Please specify an sslCAFile parameter.");
    }
    ...
    if (retWow64 && wow64Process) {
        ...
        LOGV2_OPTIONS(
            21049, {logv2::LogTag::kStartupWarnings}, "**      support larger databases.");
        warned = true;
    }
#endif
    ...
    if (serverParams.bind_ips.empty()) {
        LOGV2_OPTIONS(21051, {logv2::LogTag::kStartupWarnings}, "");
        LOGV2_OPTIONS(21052,
                      {logv2::LogTag::kStartupWarnings},
    ...
    if (auth::hasMultipleInternalAuthKeys()) {
        LOGV2_OPTIONS(21058, {logv2::LogTag::kStartupWarnings}, "");
        LOGV2_OPTIONS(
            21059,
            {logv2::LogTag::kStartupWarnings},
        ...
        LOGV2_OPTIONS(21061, {logv2::LogTag::kStartupWarnings}, "            the key file");
        warned = true;
    }

    if (warned) {
        LOGV2_OPTIONS(21062, {logv2::LogTag::kStartupWarnings}, "");
    }
}
}  // namespace mongo
