...
TEST_F(ReplCoordTest, PrepareOplogQueryMetadata) {
    ...
    LOGV2(23143, "{metadata}", "metadata"_attr = metadata);
...
TEST_F(ReplCoordTest,
    ...
    auto noi = net->getNextReadyRequest();
    auto&& request = noi->getRequest();
    LOGV2(23146, "processing {request_cmdObj}", "request_cmdObj"_attr = request.cmdObj);
    ASSERT_EQUALS(HostAndPort("node2", 12345), request.target);
    ASSERT_EQUALS("replSetHeartbeat", request.cmdObj.firstElement().fieldNameStringData());
...
TEST_F(ReplCoordTest,
    ...
    auto noi = net->getNextReadyRequest();
    auto&& request = noi->getRequest();
    LOGV2(23147, "processing {request_cmdObj}", "request_cmdObj"_attr = request.cmdObj);
    ASSERT_EQUALS(HostAndPort("node2", 12345), request.target);
...
TEST_F(ReplCoordTest,
    ...
    auto noi = net->getNextReadyRequest();
    auto&& request = noi->getRequest();
    LOGV2(23148, "processing {request_cmdObj}", "request_cmdObj"_attr = request.cmdObj);
    ASSERT_EQUALS(HostAndPort("node2", 12345), request.target);
...
TEST_F(ReplCoordTest,
    ...
    auto noi = net->getNextReadyRequest();
    auto&& request = noi->getRequest();
    LOGV2(23149, "processing {request_cmdObj}", "request_cmdObj"_attr = request.cmdObj);
    ASSERT_EQUALS(HostAndPort("node2", 12345), request.target);
