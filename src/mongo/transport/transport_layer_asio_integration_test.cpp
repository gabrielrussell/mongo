...
TEST(TransportLayerASIO, HTTPRequestGetsHTTPError) {
    ...
    LOGV2(21748, "Waiting for response");
    ...
    LOGV2(21749, "Received response: \"{httpResp}\"", "httpResp"_attr = httpResp);
